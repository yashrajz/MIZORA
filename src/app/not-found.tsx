        ...
        <div className={styles.container}>
            <div className={styles.content}>
                ...
                <div className={styles.textContent}>
                    <p className={styles.subtitle}>We're sorry we can't seem to find the page you are looking for.</p>
                    <h1 className={styles.title}>we're still blending this one!</h1>
                    <p className={styles.message}>You can go back home or</p>
