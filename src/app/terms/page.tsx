        ...
        <div className={styles.container}>
            <div className={styles.content}>
                ...
                <div className={styles.textContent}>
                    <p className={styles.subtitle}>Hold on! This page is still steeping.</p>
                    <h1 className={styles.title}>terms & conditions coming soon!</h1>
                    <p className={styles.message}>We're whisking up our terms & conditions to ensure the perfect blend.</p>
